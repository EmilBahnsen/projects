...
segment .data
	...
	_4					dq		4.0
	mdlItters		db		255
	colourUpscale	dd		15.97		; 255 / sqrt(255)
...
%macro mdl3	4
	...
	mulpd		%1, %1			;
	movapd	xmmt2, %2		; b
	mulpd		xmmt2, xmmt2	; b^2
	mulpd		xmmt2, xmmt1	; b^2·a
	mulpd		xmmt2, xVal3	; b^2·a·3
	subpd		%1, xmmt2		; a^3 - 3·a·b^2
	addpd		%1, %3			; a^3 - 3·a·b^2 + d
	; Imaginary part
...
; Modulus of complex number squared
; a + bi
; a^2 + b^2
%macro zLen2 2
	mulpd		%1, %1			; a^2
...
; That is 2^2 as we don't have to take a root then in zLen2
movddup	xmmct, [rel _4]
